...
<pre class="mcode-input">ff = chebfun(f,[0 1], 'splitting','on','minsamples',129);
LW = 'linewidth';
plot(ff,'b',LW,1.6,'numpts',1e4), grid on
title('Spike function','FontSize',14)</pre><img src="img/SpikeIntegral_01.png" alt="">
...
title('Zoom, on semilogy axes','FontSize',14)</pre><img src="img/SpikeIntegral_02.png" alt="">
...
<pre class="mcode-input">toc</pre><pre class="mcode-output">Elapsed time is 0.451306 seconds.
</pre>References:
