...
text(-1,island(2)/2,'5'), text(2,-1,'x'), text(8,-1,'13-x')</pre><img src="img/ForTheBirds_01.png" alt="">
...
xlabel('landfall point x'), ylabel('total energy of flight')</pre><img src="img/ForTheBirds_02.png" alt="">
...
xlabel('x'), ylabel('derivative')</pre><img src="img/ForTheBirds_03.png" alt="">
...
xlabel('water-to-land energy ratio'), ylabel('optimal landfall position')</pre><img src="img/ForTheBirds_04.png" alt="">
