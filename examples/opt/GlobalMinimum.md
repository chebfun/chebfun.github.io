...
[xx, yy] = meshgrid(x);
surf(xx, yy, f(xx,yy)),
title('The complicated function', 'FontSize', 16)</pre><img src="img/GlobalMinimum_01.png" alt="">
...
<pre class="mcode-input">exact = -3.306868647475237;  % minimum.</pre>We can compute this minimum using Chebfun2. The minimum is correct to 13 digits.

<pre class="mcode-input">Y = min2(g); fprintf('Computed global minimum = %1.16f\n', Y)

fprintf('Error in Chebfun2 minimum = %1.4e\n', abs(Y(1) -exact))</pre><pre class="mcode-output">Computed global minimum = -3.3068686474747921
Error in Chebfun2 minimum = 4.4498e-13
...
fprintf('Total time taken = %1.4fs\n',t)</pre><pre class="mcode-output">Total time taken = 0.6483s
</pre>Here is the plot of the minimum in a contour plot:

<pre class="mcode-input">contour(g), hold on, plot(X(1), X(2), 'k.', 'markersize', 20), hold off</pre><img src="img/GlobalMinimum_02.png" alt="">
...
zlim([-10 10]), view(-24.5,4)</pre><img src="img/GlobalMinimum_03.png" alt="">
...
[2] Folkmar Bornemann, Dirk Laurie, Stan Wagon and Joerg Waldvogel, The SIAM 100-Digit Challenge: A Study in High-Accuracy Numerical Computing, SIAM, 2004.
