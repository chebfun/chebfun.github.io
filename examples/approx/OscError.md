...
plot( [-1, 1], -[maxError maxError], 'k--', LW, 1.5)
plot( [-1, 1], [0 0], 'k--', LW, 1.5), box on</pre><img src="img/OscError_03.png" alt="">
...
h2 = plot(f - fn, 'k', LW, lw);</pre><img src="img/OscError_04.png" alt="">
...
h3 = plot(f - pLn, 'b', LW, lw);</pre><img src="img/OscError_05.png" alt="">
...
legend( [h1(:,1), h2(:,1), h3(:,1), h4(:,1)], ...
    {'L_\infty-Best', 'L_2-Cheb', 'L_2-Legn', 'Interp'})</pre><img src="img/OscError_06.png" alt="">
