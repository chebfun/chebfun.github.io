...
layout: example
authordate: "Nick Trefethen, 16 April 2014"
...
plot(f,'k',LW,1.2), grid on, axis([-1 1 -1 2]), shg</pre><img src="img/FiltersCF_01.png" class="figure" alt="">
...
end</pre><img src="img/FiltersCF_02.png" class="figure" alt="">

<img src="img/FiltersCF_03.png" class="figure" alt="">

It didn't take long to produce these pictures:

<pre class="mcode-input">toc</pre><pre class="mcode-output">Elapsed time is 4.120624 seconds.
...
for m = [100 200]
  ...
  axis([-1 1 -1 2]), snapnow
end</pre><img src="img/FiltersCF_04.png" class="figure" alt="">

<img src="img/FiltersCF_05.png" class="figure" alt="">

Here's the error:

<pre class="mcode-input">plot(f2-p,LW,1.2), grid on</pre><img src="img/FiltersCF_06.png" class="figure" alt="">
