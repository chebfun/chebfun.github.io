...
layout: example
authordate: "Nick Trefethen, 16th November 2011"
meta: "(Chebfun example ode/Orbits.m) [Tags: #nonlinearODE, #astrophysics, #IVP]"
---
...
plot(uv(0:tmax),'.k',MS,16)</pre><img src="img/Orbits_01.png" alt="">

If we want the initial speed $v$ to be a parameter, we can make an anonymous function:

<pre class="mcode-input">u = @(v) chebfun.ode113(fun,d,[u0; v],opts);</pre>Here are the orbits for $v = .5, .75, 1, 1.5, 2$.  This kind of thing is familiar from introductory physics: every orbit is an ellipse, a parabola, or a hyperbola.
...
axis([-3 3 -3 3]), axis square, grid on, shg</pre><img src="img/Orbits_02.png" alt="">
...
plot(uv,LW,1.6), axis equal, grid on, shg
plot(uv(0:tmax),'.k',MS,16)</pre><img src="img/Orbits_03.png" alt="">
...
hold off, plot([0 1],[0 0],'.r','markersize',24), hold on
plot(uv,LW,1.6), axis equal, grid on, shg
plot(uv(0:tmax),'.k',MS,16)</pre><img src="img/Orbits_04.png" alt="">
