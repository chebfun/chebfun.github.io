...
%%
% So far we have seen systems with a stable and an
% unstable fixed point, and one with
...
%%
% A system with an unstable node and collinear
% eigendirections, which corresponds
