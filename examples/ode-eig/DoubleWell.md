---
title: "Double-well Schr&Atilde;&para;dinger eigenstates"
layout: example
...
axis([-1.1 1.1 -.05 3.3]), axis off, hold on</pre><img src="img/DoubleWell_01.png" alt="">
...
disp(diag(D)), toc</pre><pre class="mcode-output">   0.091480998228160
   ...
   2.533176594996250
   2.924094539794030
Elapsed time is 3.773420 seconds.
...
end</pre><img src="img/DoubleWell_02.png" alt="">
...
ans =
   ...
   1.638922632406343
   1.750303602926205
</pre><img src="img/DoubleWell_03.png" alt="">
