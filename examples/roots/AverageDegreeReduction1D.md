...
compute_tau(f, 2)
subdivisionDiagram(f,1)</pre><pre class="mcode-output">tau = 0.00093</pre><img src="img/AverageDegreeReduction1D_02.png" class="figure" alt="">
...
compute_tau(f, 2^3)</pre><pre class="mcode-output">tau = 0.34032</pre>
...
compute_tau(f, 2)</pre><pre class="mcode-output">tau = 0.70778</pre>
...
tic, roots(f); toc</pre><pre class="mcode-output">Elapsed time is 0.409793 seconds.
</pre><pre class="mcode-input">c = -1.0001;
f = chebfun(@(x) 1./(x+c));   % example with tau approximately 0.375
tic, roots(f); toc</pre><pre class="mcode-output">Elapsed time is 1.148595 seconds.
