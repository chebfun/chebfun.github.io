...
LW = 'linewidth';
plot(f,LW,1), hold on</pre><img src="img/Histogram_01.png" alt="">
...
plot(h,'r',LW,2)</pre><img src="img/Histogram_02.png" alt="">
...
ylim([-1,max(h)+1])</pre><img src="img/Histogram_03.png" alt="">
