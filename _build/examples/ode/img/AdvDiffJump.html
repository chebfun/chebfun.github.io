...
meta: "(Chebfun example ode/AdvDiffJump.m) [Tags: #linearODE, #piecewise, #advectiondiffusion]"
---
...
axis([-10.1 10 0 20])</pre><img src="img/AdvDiffJump_01.png" alt="">
...
axis([-10.1 10 0 75])</pre><img src="img/AdvDiffJump_02.png" alt="">

For fun we can plot both solutions on the same axis.

<pre class="mcode-input">plot(u,'b',v,'--r',LW,lw), grid on
axis([-10.1 10 0 75])</pre><img src="img/AdvDiffJump_03.png" alt="">
