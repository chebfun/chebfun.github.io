...
authordate: "A. Townsend, March 2013, last updated May 2014"
---
...
plot(f), zlim([-2 2])</pre><img src="img/guide1_01.png" alt="">

There are several commands for plotting a chebfun2, including `plot`, `contour`, `surf`, and `mesh`.  Here is a contour plot of $f$:

<pre class="mcode-input">contour(f), axis square</pre><img src="img/guide1_02.png" alt="">
...
plot(fy)</pre><img src="img/guide1_03.png" alt="">
...
contour(f), axis square</pre><img src="img/guide1_04.png" alt="">
