...
f = exp(1i*s);
plot(f,'.')
axis equal</pre><img src="img/guide5_01.png" alt="">
...
f = exp(1i*s);
plot(f)
axis equal</pre><img src="img/guide5_02.png" alt="">
...
axis equal</pre><pre class="mcode-output">ans =
    17
</pre><img src="img/guide5_03.png" alt="">

We can have fun with variations on the theme:

<pre class="mcode-input">subplot(1,2,1), g = s.*exp(10i*s); plot(g), axis equal
subplot(1,2,2), h = exp(2i*s)+.3*exp(20i*s); plot(h), axis equal</pre><img src="img/guide5_04.png" alt="">

<pre class="mcode-input">subplot(1,2,1), plot(g.^2), axis equal
subplot(1,2,2), plot(exp(h)), axis equal</pre><img src="img/guide5_05.png" alt="">
...
subplot(1,2,2), plot(z.^2), axis equal, grid on</pre><img src="img/guide5_06.png" alt="">
...
hold on, plot(X,'r',LW,lw2)</pre><img src="img/guide5_07.png" alt="">
...
hold on, plot(exp(X),'r',LW,lw2)</pre><img src="img/guide5_08.png" alt="">
...
<pre class="mcode-input">  x = chebfun(@(x) x);
  ...
  clf,
  % subplot(1,2,1), plot(S), axis equal</pre><img src="img/guide5_09.png" alt="">

Here are the exponential and tangent of the grid:

<pre class="mcode-input">  subplot(1,2,1), plot(exp(S)), axis equal
  subplot(1,2,2), plot(tan(S)), axis equal</pre><img src="img/guide5_10.png" alt="">
...
% plot(1.6+exp(S))
% plot(6.6+tan(S))
% axis equal, axis off</pre><img src="img/guide5_11.png" alt="">
...
plot(S)
hold on, axis equal
plot((sqrt(5)-1)/2,0,'.k','markersize',4)</pre><img src="img/guide5_12.png" alt="">
...
axis off</pre><img src="img/guide5_13.png" alt="">
...
<pre class="mcode-input">  c = [-2+.05i, -.2+.05i, -.2-.05i, -2-.05i];    % 4 corners
  ...
  clf, plot(z), axis equal, axis off</pre><img src="img/guide5_14.png" alt="">
...
LW = 'linewidth'; lw = 2;
plot(f,LW,lw), xlim(1.1*[-1 1]), axis equal</pre><img src="img/guide5_15.png" alt="">
...
<pre class="mcode-input">plot(exp(3i*f),'m',LW,lw), ylim(1.2*[-1 1]), axis equal</pre><img src="img/guide5_16.png" alt="">
...
%f = [f box];
%plot(f,LW,lw), xlim(1.2*[-1 1]), axis equal</pre><pre class="mcode-input">clf, plot(exp((1+.2i)*f),LW,lw), axis equal, axis off</pre><img src="img/guide5_17.png" alt="">

<pre class="mcode-input">plot(tan(f),LW,lw), axis equal, axis off</pre><img src="img/guide5_18.png" alt="">
...
axis auto equal off</pre><img src="img/guide5_19.png" alt="">
