...
<pre class="mcode-input">  plot(p)
  hold on, plot(r,p(r),'.r')</pre><img src="img/guide3_01.png" alt="">
...
<pre class="mcode-input">  Ai = chebfun(@(x) airy(0,x),[-10,3]);
  ...
  axis([-10 3 -.6 1.5]), grid on</pre><img src="img/guide3_02.png" alt="">
...
<pre class="mcode-input">  x = chebfun('x',[-2 2]);
  ...
  plot(r,f(r),'or')</pre><pre class="mcode-output">r =
   0.739085133215161
</pre><img src="img/guide3_03.png" alt="">
...
<pre class="mcode-input">  x = chebfun('x',[-2 2]);
  ...
  r = roots(f);
  hold on, plot(r,0*r,'.r')</pre><img src="img/guide3_04.png" alt="">
...
<pre class="mcode-input">  r = roots(f,'nojump');
  plot(r,0*r,'.r','markersize',30)</pre><img src="img/guide3_05.png" alt="">
...
</pre><img src="img/guide3_06.png" alt="">
...
<pre class="mcode-input">  g = exp(x);
  ...
  gh = 0.5*round(2*g);
  hold on, plot(gh,'r');
  grid on</pre><img src="img/guide3_08.png" alt="">
...
<pre class="mcode-input">  f = chebfun('exp(real(airy(x)))',[-15,0]);
  clf, plot(f)
  r = roots(diff(f));
  hold on, plot(r,f(r),'.r'), grid on</pre><img src="img/guide3_09.png" alt="">
...
<pre class="mcode-input">  x = chebfun('x');
  ...
  g = 2-6*x.^2;
  h = max(f,g);
  clf, plot(h)</pre><img src="img/guide3_10.png" alt="">

Here are all the local extrema, smooth and nonsmooth:

<pre class="mcode-input">  extrema = roots(diff(h));
  hold on, plot(extrema,h(extrema),'.r')</pre><img src="img/guide3_11.png" alt="">
...
<pre class="mcode-input">  h2 = diff(h,2);
  ...
  plot(maxima,h(maxima),'ok','markersize',12)</pre><img src="img/guide3_12.png" alt="">
...
<pre class="mcode-input">  f = chebfun('sin(x)+sin(x.^2)',[0,15]);
  hold off, plot(f,'k')</pre><img src="img/guide3_13.png" alt="">
...
maxpos =
  14.234791972306914
</pre><img src="img/guide3_14.png" alt="">
...
hold on, plot(r,'om','markersize',8)</pre><img src="img/guide3_16.png" alt="">
