...
<pre class="mcode-input">  f = chebfun('cos(20*x)');
  plot(f)</pre><img src="img/guide1_01.png" alt="">
...
<pre class="mcode-input">  plot(f,'.-')</pre><img src="img/guide1_02.png" alt="">
...
<pre class="mcode-input">  g = chebfun(@(t) besselj(0,t),[0,100]);
  plot(g), ylim([-.5 1])</pre><img src="img/guide1_03.png" alt="">
...
<pre class="mcode-input">  f = chebfun({@(x) x.^2, @(x) 1+0*x, @(x) 4-x},[-1 1 2 4]);
  plot(f)</pre><img src="img/guide1_05.png" alt="">
...
<pre class="mcode-input">  plot(1./(1+f),'r')</pre><img src="img/guide1_06.png" alt="">
...
<pre class="mcode-input">  f = abs(exp(x).*sin(8*x));
  plot(f)</pre><img src="img/guide1_07.png" alt="">
...
<pre class="mcode-input">  f = sin(20*x);
  g = exp(x-1);
  h = max(f,g);
  plot(h)</pre><img src="img/guide1_08.png" alt="">
...
<pre class="mcode-input">  h = chebfun('(1/pi)./sqrt(1-x.^2)','blowup',2);
  plot(h)</pre><img src="img/guide1_10.png" alt="">
