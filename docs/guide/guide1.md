...
abs              cotd             join             rank             
acos             coth             jump             rdivide          
acosd            cov              kron             real             
acosh            csc              ldivide          reallog          
acot             cscd             le               realpow          
acotd            csch             legpoly          realsqrt         
acoth            ctranspose       length           rem              
acsc             cumprod          log              remez            
acscd            cumsum           log10            repmat           
acsch            cylinder         log1p            residue          
airy             diff             log2             restrict         
all              dirac            logical          roots            
and              disp             loglog           round            
angle            display          lt               sec              
any              domain           lu               secd             
arcLength        ellipj           mat2cell         sech             
area             ellipke          max              semilogx         
asec             end              mean             semilogy         
asecd            epslevel         measure          sign             
asech            eq               merge            simplify         
asin             erf              mesh             sin              
asind            erfc             min              sinc             
asinh            erfcinv          minandmax        sind             
atan             erfcx            minus            sinh             
atan2            erfinv           mldivide         size             
atan2d           exp              mod              sound            
atand            expm1            movie            spy              
atanh            feval            mrdivide         sqrt             
besselh          fill             mtimes           std              
besseli          find             ne               subsasgn         
besselj          fix              newDomain        subspace         
besselk          fliplr           nextpow2         subsref          
bessely          flipud           norm             sum              
bvp4c            floor            normal           surf             
bvp5c            fred             normest          surface          
cat              ge               not              surfc            
ceil             get              null             svd              
cf               gt               num2cell         tan              
cheb2cell        heaviside        or               tand             
cheb2quasi       horzcat          orth             tanh             
chebellipseplot  hscale           overlap          times            
chebfun          hypot            pde15s           transpose        
chebpade         imag             permute          uminus           
chebpoly         innerProduct     pinv             unwrap           
chebpolyplot     integral         plot             uplus            
chebtune         inv              plot3            vander           
