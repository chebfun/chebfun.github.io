...
<pre class="mcode-input">  subplot(2,2,1), plot(chebpoly(2))
  ...
  subplot(2,2,4), plot(chebpoly(50))</pre><img src="img/guide4_01.png" alt="">
...
<pre class="mcode-input">cchebfun = flipud(chebpoly(exp(x))');
...
f = chebfun('sign(x)',20);
subplot(1,2,2), plot(f,'.-'), grid on</pre><img src="img/guide4_02.png" alt="">
...
subplot(1,2,2), axis([0 .2 .5 1.5])</pre><img src="img/guide4_03.png" alt="">
...
subplot(1,2,2), plot(f,'.-'), grid on, axis([0 .004 .5 1.5])</pre><img src="img/guide4_04.png" alt="">
...
subplot(1,2,2), plot(f20,'.-'), ylim([0 1]), grid on</pre><img src="img/guide4_05.png" alt="">
...
subplot(1,2,2), plot(f1000), grid on</pre><img src="img/guide4_06.png" alt="">
...
hold  on, semilogy(NN.^(-5),'--r'), grid on</pre><img src="img/guide4_07.png" alt="">
...
text(45,1e-3,'C^{-N}','color','r','fontsize',16)</pre><img src="img/guide4_08.png" alt="">
...
p = remez(f,20);
clf, plot(f,'b',p,'r'), grid on</pre><img src="img/guide4_09.png" alt="">
...
plot(f-pinterp,'b')</pre><img src="img/guide4_11.png" alt="">
...
ylim(2e-13*[-1 1])</pre><img src="img/guide4_12.png" alt="">
...
plot([-1 1],lam*[1 1],'--k'), plot([-1 1],-lam*[1 1],'--k')</pre><img src="img/guide4_13.png" alt="">
...
plot(f), hold on, plot(p,'r'), grid on, plot(s,p(s),'.r')</pre><img src="img/guide4_14.png" alt="">
...
p = chebfun.interp1(s,f(s)); hold off
plot(f), hold on, plot(p,'r'), grid on, plot(s,p(s),'.r')</pre><img src="img/guide4_15.png" alt="">
...
<pre class="mcode-input">clf, semilogy(lebesgue(s))</pre><img src="img/guide4_16.png" alt="">

For $40$ points it is much worse:

<pre class="mcode-input">semilogy(lebesgue(linspace(-1,1,40)))</pre><img src="img/guide4_17.png" alt="">
...
plot(f)</pre><pre class="mcode-output">ans =
   354
</pre><img src="img/guide4_18.png" alt="">
...
</pre><img src="img/guide4_19.png" alt="">
...
</pre><img src="img/guide4_20.png" alt="">
