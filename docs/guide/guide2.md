...
<pre class="mcode-input">  tol = 3e-14;
  ...
  tic, I = quadgk(F,0,1,'abstol',tol,'reltol',tol); t = toc;
    fprintf('QUADGK:  I = %17.15f  time = %6.4f secs\n',I,t)</pre><pre class="mcode-output">  QUAD:  I = 0.842700792949715  time = 0.1976 secs
 QUADL:  I = 0.842700792949715  time = 0.0614 secs
QUADGK:  I = 0.842700792949715  time = 0.0379 secs
