...
% The `spin`, `spin2` and `spin3` codes use the class `spinpref`, `spinpref2`
% and `spinpref3` to manage preferences, including the choice of the
% exponential integrator for the time-stepping, the value of the time-step, the
% number of grid points and various other options. See `help/spinpref`,
% `help/spinpref2` and `help/spinpref3` for a complete list of preferences.
