...
%MAKE_CHAPTERS   Make a chapter of the Chebfun2 Guide.
%   MAKE_CHAPTERS(N) publishes Chapters of the Guide(2) indicated
%   by the vector N.
%
...
pathpath = '/Users/hrothgar/Dropbox/chebfun/guide/chebfun2/';
slug     = 'guide';
