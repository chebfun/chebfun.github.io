---
title: "CHEBFUN2 GUIDE 4: VECTOR CALCULUS"
...
Chebfun2 objects represent vector valued functions. We use a lower case letter, $f$, for a chebfun2 and an upper case letter, $F$, for a chebfun2v.
...
G = [f;g]                                          % vertical concatenation</pre><pre class="mcode-output">G = 
...
fprintf('Parallelogram law holds with error = %10.5e\n',plaw)</pre><pre class="mcode-output">Parallelogram law holds with error = 3.55271e-15
...
plot(roots(dot(F,G)),LW,1.6), axis equal, axis(d)</pre><img src="img/guide4_01.png" class="figure" alt="">
...
zlim([0 4]), hold off</pre><img src="img/guide4_02.png" class="figure" alt="">
...
title('The Duffing oscillator','FontSize',14), hold off</pre><img src="img/guide4_03.png" class="figure" alt="">
