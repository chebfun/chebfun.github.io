---
title: "CHEBFUN2 GUIDE 5: 2D SURFACES IN 3D SPACE"
...
In Chapter 4, we explored chebfun2v objects with two components, but Chebfun2 can also work with functions with three components, i.e., functions from a rectangle in $R^2$ into $R^3$. For example, we can represent the unit sphere via spherical coordinates as follows:
...
F = [x;y;z];
surf(F), camlight, axis equal</pre><img src="img/guide5_01.png" class="figure" alt="">
...
F = cylinder(r);
surf(F), camlight</pre><img src="img/guide5_02.png" class="figure" alt="">
...
F = cylinder(f);
surf(F), camlight</pre><img src="img/guide5_03.png" class="figure" alt="">
...
F = [-(1+.3*cos(phi)).*sin(theta);
      ...
      .3*sin(phi)];
surf(F), axis equal, camlight</pre><img src="img/guide5_04.png" class="figure" alt="">



# 5.2 Surface normals and the divergence theorem
...
axis equal, hold off</pre><img src="img/guide5_05.png" class="figure" alt="">
...
axis tight equal off</pre><img src="img/guide5_06.png" class="figure" alt="">



# 5.3 References

[Platte 2013] R. Platte, Parameterizable surfaces, Chebfun2 Example: <a href="http://www2.maths.ox.ac.uk/chebfun/examples/geom/html/ParametricSurfaces.shtml">http://www2.maths.ox.ac.uk/chebfun/examples/geom/html/ParametricSurfaces.shtml</a>
