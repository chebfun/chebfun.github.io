---
title: "Chebfun2 Guide 3: Rootfinding and Optimisation"
...
plot(r,LW,1.6), axis([-1 1 -1 1]), axis square</pre><img src="img/guide3_01.png" class="figure" alt="">
...
</pre>The zero contours of a function are computed by Chebfun2 to plotting accuracy and they are typically not accurate to machine precision.
...
axis([-1 1 -1 1]), axis square, hold off</pre><img src="img/guide3_02.png" class="figure" alt="">
...
hold off</pre><img src="img/guide3_03.png" class="figure" alt="">
...
zlim([-6 6]), hold off</pre><img src="img/guide3_04.png" class="figure" alt="">
...
fprintf('minandmax2 command = %5.3fs\n',t)</pre><pre class="mcode-output">min2 and max2 separately = 1.086s
minandmax2 command = 0.513s
</pre>For high accuracy the commands MIN2, MAX2, and MINANDMAX2 require the Optimisation Toolbox in MATLAB.
...
axis square</pre><img src="img/guide3_05.png" class="figure" alt="">
...
[Guettel Example 2010] S. Guettel, <a href="http://www2.maths.ox.ac.uk/chebfun/examples/geom/html/Area.shtml">http://www2.maths.ox.ac.uk/chebfun/examples/geom/html/Area.shtml</a>

[Nakatsukasa, Noferini &amp; Townsend 2013] Y. Nakatsukasa, V. Noferini and A. Townsend, Computing the common zeros of two bivariate functions via Bezout resultants, _Numerische Mathematik_, to appear.

[Trott 2007] M. Trott, Applying Groebner Basis to Three Problems in Geometry, _Mathematica in Education and Research_, 6 (1997), pp.15-28.
