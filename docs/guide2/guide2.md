...
<pre class="mcode-input">help chebfun2/diff</pre><pre class="mcode-output"> DIFF   Derivative of a CHEBFUN2s.
...
</pre>Here we use `diff` to check that the Cauchy-Riemann equations hold for an analytic function.
...
norm(diff(u,1,2) - diff(v))         % Do the Cauchy-Riemann eqns hold?</pre><pre class="mcode-output">ans =
     1.338374214376637e-14
ans =
     2.474692330575973e-14
</pre>
...
fprintf('Integral3:  I = %16.14f  time = %5.3f secs\n',I,t)</pre><pre class="mcode-output"> Chebfun2:  I = -0.48056569408898  time = 1.992 secs
Integral3:  I = -0.48056569417568  time = 0.600 secs
</pre>
